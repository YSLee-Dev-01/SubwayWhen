    ...
    func testScheduleCellTransform(){
        ...
        expect(observer.events).to(
            equal([
                ...
                .next(2, [
                    MainTableViewCellData(upDown: "상행", arrivalTime: "000", previousStation: "", subPrevious: "정보없음", code: "000", stationName: "교대", lastStation: "교대행", isFast: "",  group: "", id: "-", stationCode: "340", exceptionLastStation: "", type: .schedule, backStationId: "1003000339", nextStationId: "1003000341", korailCode: "", stateMSG: "000", subwayLineData: subwayLineData), mainCellDummyData,
                ]),
                .next(5, [
                    MainTableViewCellData(upDown: "상행", arrivalTime: "000", previousStation: "", subPrevious: "정보없음", code: "000", stationName: "교대", lastStation: "교대행", isFast: "", group: "", id: "-", stationCode: "340", exceptionLastStation: "", type: .schedule, backStationId: "1003000339", nextStationId: "1003000341", korailCode: "", stateMSG: "000",  subwayLineData: subwayLineData), MainTableViewCellData(upDown: "상행", arrivalTime: "000", previousStation: "", subPrevious: "정보없음", code: "000",  stationName: "교대", lastStation: "교대행", isFast: "",  group: "", id: "-", stationCode: "340", exceptionLastStation: "", type: .schedule, backStationId: "1003000339", nextStationId: "1003000341", korailCode: "", stateMSG: "000",  subwayLineData: subwayLineData)
                ]),
                .next(7, [
                    MainTableViewCellData(upDown: "상행", arrivalTime: "000", previousStation: "", subPrevious: "정보없음", code: "000", stationName: "교대", lastStation: "교대행", isFast: "", group: "", id: "-", stationCode: "340", exceptionLastStation: "", type: .schedule, backStationId: "1003000339", nextStationId: "1003000341", korailCode: "", stateMSG: "000",  subwayLineData: subwayLineData),  MainTableViewCellData(upDown: "상행", arrivalTime: "000", previousStation: "", subPrevious: "정보없음", code: "000",  stationName: "교대", lastStation: "사당행",  isFast: "", group: "", id: "-", stationCode: "340", exceptionLastStation: "", type: .schedule, backStationId: "1003000339", nextStationId: "1003000341", korailCode: "", stateMSG: "000",  subwayLineData: subwayLineData)
                ])
